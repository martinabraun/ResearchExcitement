...
fig <- ggplot(data = df, aes(
  ...
  geom_point(mapping = aes(x = 1.25, y = 100), shape = 21, color = pal_fun, fill = pal_bg, size = 4) +
  ...
  # x axis groupings
  geom_segment(mapping = aes(x = groupings_df$start_seg, xend = groupings_df$end_seg, y = -40, yend = -40),
               color = pal_bioinfo, size = 0.3) +
  geom_segment(mapping = aes(x = groupings_df$start_seg, xend = groupings_df$start_seg, y = -40, yend = -35),
               color = pal_bioinfo, size = 0.3) +
  geom_segment(mapping = aes(x = groupings_df$end_seg, xend = groupings_df$end_seg, y = -40, yend = -35),
               color = pal_bioinfo, size = 0.3) +
  # segments to connect images to groupings
  geom_segment(mapping = aes(x = groupings_df$half, xend = groupings_df$half, y = -40, yend = -50), 
               color = pal_bioinfo, size = 0.3) +
  # grouping labels
